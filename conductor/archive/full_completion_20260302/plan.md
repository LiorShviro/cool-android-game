...
- [x] Task: Ensure all 5 stations are correctly balanced in the `App.tsx` station scroll view. (Commit: manual verification)
- [x] Task: Verify end-to-end flow from Main Menu -> Play -> Game Over -> Leaderboard. (Commit: manual verification)
